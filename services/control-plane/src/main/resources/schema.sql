...
ALTER TABLE data_os.quality_rule_runs ADD COLUMN IF NOT EXISTS artifact_uri VARCHAR(1000) NULL;
ALTER TABLE data_os.quality_rule_runs ADD COLUMN IF NOT EXISTS reconciliation_status VARCHAR(40) NULL;
ALTER TABLE data_os.quality_rule_runs ADD COLUMN IF NOT EXISTS reconciliation_message VARCHAR(500) NULL;
